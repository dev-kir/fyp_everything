...
#   ./scenario2_ultimate.sh 8 6 60 6 4 25 300     # Fewer users, higher per-user load
#
# Parameters:
...
echo "    - Before: 1 replica at ~80% CPU, ~${TOTAL_MEMORY}MB RAM"
echo "    - After:  2 replicas at ~40% CPU each, ~$((TOTAL_MEMORY / 2))MB RAM each"
