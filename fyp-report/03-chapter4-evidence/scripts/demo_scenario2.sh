...
#
# NOTE: This runs scenario2_ultimate.sh in FOREGROUND so you can see output
# ============================================================================
...
# ============================================================================
# STEP 2: Clean up and deploy fresh web-stress service (1 replica)
# ============================================================================
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "STEP 2: Cleaning up and deploying fresh web-stress service..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ============================================================================
# STEP 3: Run scenario2_ultimate.sh in FOREGROUND
# ============================================================================
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "STEP 3: Running Scenario 2 Load Test (FOREGROUND)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  This will run scenario2_ultimate.sh in FOREGROUND"
echo "  You will see all output from the load generator"
echo ""
echo "  Parameters:"
echo "    USERS_PER_ALPINE: 8"
echo "    CPU per user: 5%"
echo "    Memory per user: 50MB"
echo "    Network per user: 8Mbps"
echo "    Total: 8 × 5 alpines = 40 users"
echo "    Expected: ~200% CPU, ~2000MB Memory, ~320Mbps Network"
echo ""
echo "  Watch for:"
echo "    - Grafana showing load increase"
echo "    - Recovery manager detecting high load"
echo "    - Replica count increasing 1 → 2"
echo ""
...
# Record start time
echo "SCENARIO2_STARTED: $(date -Iseconds)" >> "$OUTPUT_DIR/demo_scenario2_${TIMESTAMP}.log"

# Run scenario2_ultimate.sh in FOREGROUND (not background!)
# Parameters: USERS_PER_ALPINE CPU% MEM_MB NET_MBPS STAGGER RAMP HOLD
cd /Users/amirmuz/fyp_everything/swarmguard
./tests/scenario2_ultimate.sh 8 5 50 8 3 30 240

# Record end time
echo "SCENARIO2_FINISHED: $(date -Iseconds)" >> "$OUTPUT_DIR/demo_scenario2_${TIMESTAMP}.log"

echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "STEP 4: Capturing final results..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "║    $OUTPUT_DIR/demo_scenario2_${TIMESTAMP}.log"
